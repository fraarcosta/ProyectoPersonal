# start.ps1 — arranque de agent-economico con variables de entorno desde .env
...
Write-Host "[agent-economico] Arrancando en puerto $env:PORT ..."
Write-Host "[agent-economico] LLM: $env:LLM_PROVIDER_TYPE / $env:ANTHROPIC_MODEL"
Write-Host "[agent-economico] API key present: $([bool]$env:ANTHROPIC_API_KEY)"

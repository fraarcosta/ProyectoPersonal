# start.ps1 — arranque de agent-oferta con variables de entorno desde .env
...
Write-Host "[agent-oferta] Arrancando en puerto $env:PORT ..."
Write-Host "[agent-oferta] LLM: $env:LLM_PROVIDER_TYPE / $env:ANTHROPIC_MODEL"
Write-Host "[agent-oferta] API key present: $([bool]$env:ANTHROPIC_API_KEY)"

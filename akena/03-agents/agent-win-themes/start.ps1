# start.ps1 — arranque de agent-win-themes con variables de entorno desde .env
...
Write-Host "[agent-win-themes] Arrancando en puerto $env:PORT ..."
Write-Host "[agent-win-themes] LLM: $env:LLM_PROVIDER_TYPE / $env:ANTHROPIC_MODEL"
Write-Host "[agent-win-themes] API key present: $([bool]$env:ANTHROPIC_API_KEY)"
